...
describe Example do
  ...
  context "checks mass assignments" do
    describe "User" do
  ...
  context "Others" do
    describe User do
      ...
      it { should be_timestamped_document } # if you're declaring `include Mongoid::Timestamps` or any of `include Mongoid::Timestamps::Created` and `Mongoid::Timestamps::Updated`
